...
public class VatLy1LyThuyetFragment extends Fragment {
    ...
    int n[] = {R.drawable.li10, R.drawable.li11, R.drawable.li12, R.drawable.li13, R.drawable.li14, R.drawable.li15};
    int i = 0;
    ...
    private void prev() {
        if (i > 0) {
            ...
            i = n.length;
            //Toast.makeText(getActivity(),"Vui lòng ấn \"tiếp\" ! ",Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void next() {
        if (i < n.length - 1) {
            ...
            i = -1;
            //Toast.makeText(getActivity(),"Vui lòng ấn \"trước\" ! ",Toast.LENGTH_SHORT).show();
        }
    }
