package com.project.daicuongbachkhoa.ui.muctieu;
...
public class MucTieuFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        final View view = inflater.inflate(R.layout.fragment_muctieu, container, false);
        ...
        btnKq.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    float giuaKi = 0;
                    giuaKi = Float.parseFloat(txtGiuaKi.getText().toString());
                    float cuoiKi = 0;
                    cuoiKi = Float.parseFloat(txtCuoiKi.getText().toString());
