...
public class VatLy1Fragment extends Fragment {
    ...
    Button btnVatLy1LyThuyet;
    Button btnVatLy1OnTap;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnVatLy1LyThuyet = view.findViewById(R.id.btnVatLy1LyThuyet);
        btnVatLy1LyThuyet.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                VatLy1LyThuyetFragment vatLy1LyThuyetFragment = new VatLy1LyThuyetFragment();
                FragmentTransaction fragmentTransaction = getFragmentManager().beginTransaction();
                fragmentTransaction.replace(R.id.nav_host_fragment, vatLy1LyThuyetFragment);
                fragmentTransaction.addToBackStack(null);  // if written, this transaction will be added to backstack
                fragmentTransaction.commit();
            }
        });

        btnVatLy1OnTap = view.findViewById(R.id.btnVatLy1OnTap);
        btnVatLy1OnTap.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //getActivity cho nhanh, lấy màn hình hiện tại và thay thế màn hình khác !
                Intent intent = new Intent(getActivity(), VatLy1OnTap.class);
        ...
        btnVatLy1DeThi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                VatLy1DeThiFragment vatLy1DeThiFragment = new VatLy1DeThiFragment();
                FragmentTransaction fragmentTransaction = getFragmentManager().beginTransaction();
                //fragmentTransaction.replace(R.id.nav_host_fragment, vatLy1DeThiFragment);
                fragmentTransaction.replace(R.id.nav_host_fragment, vatLy1DeThiFragment);
                fragmentTransaction.addToBackStack(null);  // if written, this transaction will be added to backstack
                fragmentTransaction.commit();
            }
